    ...
    <>
      ...
      <main style={{
              ...
              <div className="mob-nav-links" style={{ display: 'flex', gap: '36px' }}>
                {navItems.map(({ label, href }) => (
                  <span
                    ...
                    style={{ fontFamily: "'Space Mono', monospace", fontSize: '12px', letterSpacing: '0.18em', textTransform: 'uppercase', color: label === 'Home' ? '#fff' : '#888', cursor: 'pointer' }}
                    onMouseEnter={e => { if (label !== 'Home') e.target.style.color = '#fff' }}
                    onMouseLeave={e => { if (label !== 'Home') e.target.style.color = '#888' }}
                  >
                    {label}
                  </span>
                ))}
            ...
            <div style={{ borderTop: '0.5px solid #111', display: 'flex', flexDirection: 'column' }}>
              {navItems.map(({ label, href }) => (
                <span
                  ...
                  style={{ fontFamily: "'Space Mono', monospace", fontSize: '13px', letterSpacing: '0.18em', textTransform: 'uppercase', color: label === 'Home' ? '#fff' : '#888', padding: '16px 20px', cursor: 'pointer', borderBottom: '0.5px solid #111', display: 'block' }}
                >
                  {label}
                </span>
              ))}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
          ...
          <div style={{ fontFamily: "'Space Mono', monospace", fontSize: '9px', letterSpacing: '0.25em', color: '#333', textTransform: 'uppercase', margin: '8px 0 0' }}>// Custom AI Deployments</div>
